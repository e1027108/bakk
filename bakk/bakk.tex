...
As we have seen in the previous section, often there may be overlaps between the different extension types. In this section we will discuss those relations between extension types.\dl
	...
	\begin{figure}[!htb]
		...
		\begin{tikzpicture}[fill=white]
			...
			\scope
				...
				\fill (1,0) circle (1);
			\endscope
			\draw (3.5,3.5) circle (4.75) (3.5,7.5) node [text=black,above] {$cf(F)$}
				(3.5,3.5) circle (4) (3.5,6.5) node [text=black,above] {$adm(F)$}
				(2.25,4.25) circle (1.75) node [text=black] {$prf(F)$}	
				(4.75,4.25) circle (1.75) node [text=black] {$st(F)$}
				(3.5,2) circle (1.75) (3.5, 1.5) node [text=black] {$co(F)$}
				(3.5,2.75) circle (.75) (3.5, 2.5) node [text=black] {$gr(F)$}
				(-2,-2) rectangle (9,9) (3.5,8.75) node [text=black]{$sets(F)$};
		\end{tikzpicture}
